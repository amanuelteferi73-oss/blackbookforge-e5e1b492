...
import { getScoreHistory, getUserState, getCheckIns } from '@/lib/dataStore';
...
export default function ProgressPage() {
  ...
  useEffect(() => {
    setScoreHistory(getScoreHistory(30));
    setUserState(getUserState());
    setTotalCheckIns(Object.keys(getCheckIns()).length);
  }, []);
  ...
  return (
    <div className="min-h-screen pb-20 md:pb-0">
      <div className="container mx-auto px-4 pt-6">
        ...
        <div className="execution-card p-6 rounded">
          ...
          {scoreHistory.length > 0 ? (
            <div className="space-y-2">
              {scoreHistory.slice().reverse().map(({ date, score }) => (
        ...
        {/* Longest Streak */}
        {userState && userState.longestStreak > 0 && (
